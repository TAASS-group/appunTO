...
public interface NotificationRepository extends JpaRepository<Notification, Long> {
    ...
    List<Notification> findUnseenNotificationsByCourseAndUser(@Param("courseId") long courseId, @Param("userId") String userId);
    ...
    List<Notification> findSeenNotificationsByCourseAndUser(@Param("courseId") long courseId, @Param("userId") String userId);
}
