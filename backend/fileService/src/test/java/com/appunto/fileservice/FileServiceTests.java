...
//    void updateFile(){
//        MyFile f = fileService.addFile("test1");
//        Commit commit = fileService.updateFile(f.getId(),"TITLE", "Updated note.md", "ME", "Hello, World!\n\nThis is a new line!");
//        assert (commit != null);
//    }
//
//    @Test
...
//        Commit commit1 = fileService.updateFile(f.getId(), "TITLE","Updated note.md", "Me", "Hello, World!\n\nThis is a new line!");
//        Commit commit2 = fileService.updateFile(f.getId(), "TITLE","Updated note.md", "Me", "Hello, World!\n\nThis is a new line!\n\nThis is another new line!");
